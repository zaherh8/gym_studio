defmodule GymStudioWeb.Admin.ExercisesLive do
  ...
  def handle_event("save", %{"exercise" => params}, socket) do
    result =
      case socket.assigns.editing do
        nil -> Progress.create_exercise(params)
  ...
  def handle_event("delete", %{"id" => id}, socket) do
    ...
    case Progress.delete_exercise(exercise) do
      ...
      {:error, :cannot_delete_predefined} ->
        {:noreply, put_flash(socket, :error, "Cannot delete predefined exercises.")}
    end
  end
  ...
  def render(assigns) do
    ...
    <div class="container mx-auto p-6">
      <div class="flex justify-between items-center mb-6">
        ...
        <button phx-click="new" class="btn btn-primary">Add Exercise</button>
      </div>
      ...
      <%= if @show_form do %>
        <div class="card bg-base-200 mb-6">
          <div class="card-body">
            <h2 class="card-title">
              {if @editing, do: "Edit Exercise", else: "New Exercise"}
            </h2>
