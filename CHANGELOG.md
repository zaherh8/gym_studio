...
### Added
- Meet the Team section with real trainer photos and bios (#28)
- Trainer photos served from the CDN at 400w/800w, lazy loaded

## [0.10.0] - 2026-09-12

### Added
- Stats section with counters that animate from zero on scroll into view (#144)
- 100+ members and 9 trainers, below the fold between "Why React" and testimonials
